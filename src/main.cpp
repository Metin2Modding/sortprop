...
#define MAP_PATH "sortprop\\map\\"
#define OLD_PROPERTY_PATH "sortprop\\property_old\\"
#define NEW_PROPERTY_PATH "sortprop\\property_new\\"

int
main()
{
  loader::initialize(true, MAP_PATH);
}
...
//   {
//     for (auto& i :
//     std::filesystem::recursive_directory_iterator(MAP_ARCHIVE)) {
//       /*
//        * F I L E
//        */
//       auto& path = i.path();
